...
# Обновляем версию
import re
html = re.sub(r'styles\.css\?v=[\d.]+', 'styles.css?v=6.0', html)
html = re.sub(r'script\.js\?v=[\d.]+', 'script.js?v=6.0', html)
...
ssh.close()
print("\n✅ Готово!")
print("   - muted полностью убран из HTML")
